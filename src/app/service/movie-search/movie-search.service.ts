...
export class MovieSearchService {
  ...
  movies: Movie[] = this.moviesData.movies;
  ...
  */
  ...
  getTopMovies(n: number): Observable<Movie[]> {
    return this.getTopMoviesByInterval(0, n);
  }

  getTopMoviesByInterval(f: number, t: number): Observable<Movie[]> {
    return of<Movie[]>(
